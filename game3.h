        ...
        for(int i=0;i<5;i++)
        {
            for(int j=1;j<4;j++)
            {
                if((this->board[i][j]==this->board[i][j+1] )&& (this->board[i][j]==this->board[i][j-1]) &&this->board[i][j]!=0 )
                {
                    ...
                    cerr<<"horizontal check"<< "fot the char "<<this->board[i][j]<<endl;
                }
            }
        ...
        for(int i=1;i<4;i++)
        {
            for(int j=0;j<5;j++)
            {
                if((this->board[i][j]==this->board[i+1][j] )&& (this->board[i][j]==this->board[i-1][j])&&this->board[i][j]!=0 )
                {
                    ...
                    cerr<<"vertical check"<< "fot the char "<<this->board[i][j]<<endl;
                }
            }
        }
        //inc diagonal check
        for(int i=2;i<5;i++)
        {
            for(int j=0;j<=2;j++)
            {
                if(((this->board[i][j]==this->board[i-1][j+1]) && (this->board[i][j]==this->board[i-2][j+2]) && this->board[i][j]!=0 ))
                {
                    ...
                    cerr<<"inc diagonal check"<< "fot the char "<<this->board[i][j]<<endl;
                }
            }
        }
        //dec diagonal check
        for(int i=0;i<=2;i++)
        {
            for(int j=0;j<=2;j++)
            {
                if(((this->board[i][j]==this->board[i+1][j+1]) && (this->board[i][j]==this->board[i+2][j+2]) &&this->board[i][j]!=0 ))
                {
                    ...
                    cerr<<"dec diagonal check"<< "fot the char "<<this->board[i][j]<<endl;
                }
            }
        }


        cout<<count_player1<<"           :          "<<count_player2<<endl;
